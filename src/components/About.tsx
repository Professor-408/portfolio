        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4 group relative overflow-hidden">
            <span className="beyond-gradient group-hover:scale-110 transition-transform duration-500 inline-block">
              About <span className="beyond-gradient-text">Me</span>
            </span>
          </h2>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-blue-400 font-medium mb-2">
                      <a href="https://www.lwindia.com/" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-300">LinuxWorld Pvt. Ltd.</a>
                    </p>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-400">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <a href="https://maps.app.goo.gl/RJ23cB3NFcFvEkpaA" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-300">Jaipur, Rajasthan, India</a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-400">
                      ...
                      <div className="flex items-center gap-1">
                        <MapPin className="w-4 h-4" />
                        <a href="https://maps.app.goo.gl/LHzweWrnHgGkvVWt6" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-300">Giridih, Jharkhand, India</a>
                      </div>
                    </div>
                  </div>
                </div>
